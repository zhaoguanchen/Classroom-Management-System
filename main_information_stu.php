...
include './includes/mysql_connect.php';
			...
			*/	  
                ...
                //number的查询
              $sql_2 = "SELECT `number` FROM `student` WHERE `name` = $name";
               // ; 
               //SQL语句  
                  $result_2 = mysql_query($sql_2);    //执行SQL语句  
                  $num_2 = mysql_num_rows($result_2); //统计执行结果影响的行数 
				  $number = mysql_result($result_2,0); 
				 /* echo $num_2;
				  if($num_2)
				  {
				 // echo $sql;
				  ...
				  */
                    //class的查询
              $sql_3 = "SELECT `class` FROM `student` WHERE `name` = $name";
               // ; 
               //SQL语句  
                  $result_3 = mysql_query($sql_3);    //执行SQL语句  
                  $num_3 = mysql_num_rows($result_3); //统计执行结果影响的行数 
				  $class = mysql_result($result_3,0); 
			/*	  echo $num_3;
				  if($num_3)
				  {
				 // echo $sql;
      ...
      //class的查询
              $sql_4 = "SELECT `tel` FROM `student` WHERE `name` = $name";
               // ; 
               //SQL语句  
                  $result_4 = mysql_query($sql_4);    //执行SQL语句  
                  $num_4 = mysql_num_rows($result_4); //统计执行结果影响的行数 
				  $tel = mysql_result($result_4,0); 
				//  echo $num_3;
			/*	  if($num_3)
				  {
				 // echo $sql;
    ...
    $sql_5 = "SELECT `relname` FROM `student` WHERE `name` = $name";
               // ; 
               //SQL语句  
                  $result_5 = mysql_query($sql_5);    //执行SQL语句  
                  $num_5 = mysql_num_rows($result_5); //统计执行结果影响的行数 
				  $relname = mysql_result($result_5,0); 
?>    
...
<html>  
    ...
    <div >
        ...
        <div >  
            ...
            <form action="info_change_stu.php" method="post" id="regForm">  
