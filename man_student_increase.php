...
?>
   ...
   <div align="center">
    <form action="man_student_increase_2.php" method="post" id="submit">  
  <div class="group">  
                 ...
                 <div class="group">  
                    ...
                    <input type="text" name="number" style="width:200px; height=100px ;" />  
                </div>  
                 <div class="group">  
                    <label for="nickname">真实姓名:</label>  
                    <input type="text" name="relname"style="width:200px; height=100px ;" />  
                </div> 
               <div class="group">  
                    <label for="nickname">班级:</label>  
                    <input type="text" name="class"style="width:200px; height=100px ;" />  
                </div> 
                <div class="group">  
                    <label for="nickname">电话:</label>  
                    <input type="text" name="tel"style="width:200px; height=100px ;" />  
                </div>  
                 <div class="group">  
                    <label for="nickname">密码:</label>  
                    <input type="text" name="password"style="width:200px; height=100px ;" />  
                </div> 
                 <div class="group">  
