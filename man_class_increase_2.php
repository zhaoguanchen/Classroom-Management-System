       ...
       if($id == "" || $name == "" || $location == "" || $max == "" )  
            ...
            {  
                ...
                include "./includes/mysql_connect.php";  
                     ...
                     $sql = "SELECT * FROM `classroom` WHERE `ID` = $id "; //SQL语句  
                    ...
                    {  
                        $sql_insert = "INSERT INTO `classmanage`.`classroom` (`ID`, `name`,`location`, `max`) VALUES ('$_POST[id]','$_POST[name]','$_POST[location]','$_POST[max]')";
