        ...
        <div id="wechat" class="nav-down-menu menu-3 menu-1" style="display: none;" _t_nav="wechat">
			<div class="navigation-down-inner">
				...
				<dl>
					<dt>会议室借用</dt>
					<dd>
						<a hotrep="hp.header.product.monitoring1" href="man_manage_meetting.php">会议室管理</a>
					</dd>
					<dd>
...
<?php
echo '<a href="man_student_increase.php">点击此处增加用户</a>';	 
?>
<br>
 <?php
...
<table border=10 cellspacing=10  align="center" bordcolor = "#00FF00" width="800"  height="100" bgcolor="#FFFF99"> 
         ...
         <tr cellspacing=10  align="center" height=20 bgcolor="#FF00CC"><th>用户名</th><th>学号</th><th>姓名</th><th>班级</th><th>联系方式</th><th>操作</th></tr>
    <?php
      $flag;
   ...
   if($num)
   {
          ...
          for($i=0;$i<$num;$i++){
     		...
     		//	    echo "<tr bordercolor='#66CCCC'  bgcolor='#99FF00' ><td>$id</td><td>$number</td><td>$relname</td><td>$class</td><td>$tel</td><td><a class='book popup-with-zoom-anim button-isi zoomIn animated' data-wow-delay='.5s' href='#small-dialog'>修改</a></td></tr>";
			  ...
			  echo "<tr bordercolor='#66CCCC'  align='center' bgcolor='#99FF00' ><td>$id</td><td>$number</td><td>$relname</td><td>$class</td><td>$tel</td><td><a href='man_change_sinfo.php?id=$id'>修改</a></td></tr>";
            }
   }
   else
   { 
