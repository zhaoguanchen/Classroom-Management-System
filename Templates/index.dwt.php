...
<div class="container">
  <header>
    <a href="#"><img src="../image/hand.png" alt="徽标"width="180" height="90" id="Insert_logo" style="background-color: #C6D580; display:block;" /></a>
  </header>
  <div class="sidebar1">
    <ul class="nav">
        <li><a href="../test.php">链接 1</a></li>
        <li><a href="../register.php">链接 2</a></li>
        <li><a href="#">链接 3</a></li>
        <li><a href="#">链接 4</a></li>
    </ul>
    <aside>
